...
public sealed partial class SettingsForm
{
    ...
    private void AddValueSettings(Control p)
    {
        ...
        Dep(() =>
        {
            unit.Enabled = _c.ShowNetUp || _c.ShowNetDown;
            swap.Enabled = _c.ShowNetUp && _c.ShowNetDown;
            mem.Enabled = _c.ShowMem && _c.MemStyle == DisplayStyle.Digital;
            busyStyle.Enabled = _c.ShowDiskBusy;
        });
    }
}
