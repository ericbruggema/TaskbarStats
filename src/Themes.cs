...
public sealed partial class ThemeData
{
    ...
    public static ThemeData Capture(AppSettings c, string name)
    {
        ...
        return new ThemeData
        {
            ...
            GraphSeconds = c.GraphSeconds, GraphLength = c.GraphLength, NetStyle = c.NetStyle, PingStyle = c.PingStyle,
    ...
    public void ApplyTo(AppSettings c)
    {
        ...
        c.GraphSeconds = GraphSeconds <= 30 ? 30 : GraphSeconds >= 120 ? 120 : 60; c.GraphLength = GraphLength; c.NetStyle = NetStyle; c.PingStyle = PingStyle;
